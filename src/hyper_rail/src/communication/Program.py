...
Tis.openDevice("31614320", 640, 480, "30/1",TIS.SinkFormats.BGRA, False)
...
Tis.Set_Property("Whitebalance Auto", "Off")
...
if Tis.Get_Property("Exposure Auto").value :
        Tis.Set_Property("Exposure Auto", "Off")
        print("Exposure Auto now : %s " % Tis.Get_Property("Exposure Auto").value)

Tis.Set_Property("Exposure", 84000)
Tis.Set_Property("Whitebalance Mode", "WhiteBalanceMode_Temperature")
